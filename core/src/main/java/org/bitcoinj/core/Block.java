...
public class Block extends Message {
	...
	if (nonce==1591189 && time==1413817324) {
                log.warn("ok lets do this shit by hand holmes - genesis hash comin atya");
		return new Sha256Hash(Utils.HEX.decode("30758383eae55ae5c7752b73388c1c85bdfbe930ad25ad877252841ed1e734a4")); 
	}       
	try {
            ByteArrayOutputStream bos = new UnsafeByteArrayOutputStream(HEADER_SIZE);
            writeHeader(bos);
            //log.warn("calculated: " + Sha256Hash.wrapReversed(Sha256Hash.hashTwice(bos.toByteArray())).toString());
