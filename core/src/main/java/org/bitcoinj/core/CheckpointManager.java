...
public class CheckpointManager {
    ...
    public static void checkpoint(NetworkParameters params, InputStream checkpoints, BlockStore store, long time)
        ...
        System.out.println("Inside CheckpointManager.checkpoint static bullshit");
        checkNotNull(params);
        checkNotNull(store);
        ...
        System.out.println("We made our CheckPointManager inside CheckpointManager.checkpoint now gonna get checkpoint");
        StoredBlock checkpoint = manager.getCheckpointBefore(time);
        System.out.println("checpoint got a storedBlock checkpoint");
        store.put(checkpoint);
        System.out.println("Put that shit word up G in checkpointManager");
