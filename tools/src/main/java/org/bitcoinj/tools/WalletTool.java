...
public class WalletTool {
    ...
    private static void setup() throws BlockStoreException {
	    ...
	    System.out.println("Here we are setting up SPVBlockStore in WalletTool");
            store = new SPVBlockStore(params, chainFileName);
            System.out.println("Created spvstore store in wallettool");
            chain = new BlockChain(params, wallet, store);
            System.out.println("created blockchain chain in wallettool w/ reset = " + reset);
            if (reset) {
                try {
